...
@if (isset($editModeData))
    ...
    @section('toolbarTitle', 'Edit Gallery')
@else
    @section('title', 'Create Gallery')
    @section('toolbarTitle', 'Create Gallery')
@endif
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.gallery.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="kt_gallery_form" method="POST" enctype="multipart/form-data"
                        action="{{ isset($editModeData) ? route('admin.gallery.update', $editModeData->id) : route('admin.gallery.store') }}">
                        @csrf

                        @isset($editModeData)
                            @method('PUT')

                            <input type="text" hidden name="gallery_id" value="{{ $editModeData->id }}">
                        @endisset
