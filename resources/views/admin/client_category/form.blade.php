...
@if (isset($editModeData))
    ...
    @section('toolbarTitle', 'Edit Client Category')
@else
    @section('title', 'Create Client Category')
    @section('toolbarTitle', 'Create Client Category')
@endif
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.client-category.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST"
                        action="{{ isset($editModeData) ? route('admin.client-category.update', $editModeData->id) : route('admin.client-category.store') }}">
                        @csrf

                        @isset($editModeData)
                            @method('PUT')

                            <input type="text" hidden name="client_category_id" value="{{ $editModeData->id }}">
                        @endisset
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 fv-row mb-5">
                                ...
                                <textarea class="form-control form-control-solid" placeholder="Enter details" name="details" data-kt-autosize="true">{{ $editModeData->details ?? old('details') }}</textarea>
                                @error('details')
                                    <span class="text-danger mt-2">{{ $message }}</span>
                                @enderror
                            </div>
