...
@if (isset($editModeData))
    ...
    @section('toolbarTitle', 'Edit Our Client')
@else
    @section('title', 'Create Our Client')
    @section('toolbarTitle', 'Create Our Client')
@endif
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.our-client.index') }}" class="btn btn-sm btn-light-success">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form" method="POST" enctype="multipart/form-data"
                        action="{{ isset($editModeData) ? route('admin.our-client.update', $editModeData->id) : route('admin.our-client.store') }}">
                        @csrf

                        @isset($editModeData)
                            @method('PUT')

                            <input type="text" hidden name="client_id" value="{{ $editModeData->id }}">
                        @endisset
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row mb-5">
                                ...
                                <select name="category_name" data-control="select2" data-placeholder="Select Category"
                                    class="form-select form-select-solid category">
                            ...
                            <div class="col-md-6 fv-row mb-5">
                                ...
                                @isset($editModeData->logo)
                                    <a target="_blank" href="{{ asset('uploads/our_client/' . $editModeData->logo) }}">
                                        View Logo</a>
                                @endisset
