            ...
            <div id="page-full-width-homepage" class="full-width person-detail" role="main">
                ...
                <div class="experience__wrapper row body__wrapper columns small-12 medium-12 large-12">
                    <div class="medium-2 large-2 small-12 sidebar__on-scroll--fixed columns">
                        <a href="/practices-areas" class=" title__text smaller hide-for-small-only list__header">
                            Experience
                        </a>
                        ...
                        <div id="sidebarMobileAccordion" class="sidebar-items__wrapper insights show-for-small-only">
                            <a class="medium__weight__spacing  link mobile sidebar__link" href="/practices-areas">
                                PRACTICES AREAS
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div
                            class="columns no__pad small-9 medium-9 large-9 relative float--right people__details--container">
