        ...
        <div id="page-full-width-homepage" class="full-width person-detail" role="main">
            <div id="featuredImage" class="featured-image__header--image-wrapper"
                ...
                <div class="backstretch"
                    ...
                    <img src="{{ asset('assets/frontend/images/people/banner-people.jpg') }}"
                        style="position: absolute; margin: 0px; padding: 0px; border: none; max-height: none; max-width: none; z-index: -999999; width: 1519px; height: 234.52px; left: 0px; top: -9.75991px;">
                </div>
            </div>

            <div class="row">
                <div class="columns no__pad small-12 medium-12 large-12 relative float--right people__details--container">
                                ...
                                <div class="columns medium-6 large-4 small-12">
                                    <div class="people__image__container">
                                        <img class="people__details" style="width: 150px; height: 139px;"
                                            src="assets/frontend/images/people/Abdur-Razzaq.jpg" alt="Abdur Razzaq-Siddiq">
                                    </div>
                                </div>
                                    ...
                                    <div class="people__details--outer-wrapper">
                                        <div class="people__details--inner-wrapper">
                                            ...
                                            <a href="mailto:abdurrazzaq@thelawcounsel.com"
                                                class="email--people--link red link inline__link" style="font-size: 13px;">
                        ...
                        <div class="diversity__modal--inner-wrapper table__innner">
                            <div class="diversity__modal--text-wrapper email__modal">
                                ...
                                <p class="modal__text">
                                    ...
                                    to others and (ii) you have read and understand the <a class="link red inline__link"
                                        href="/terms-of-use/" target="_blank">Brown Rudnick Terms of Use</a> and <a
                                        class="link red inline__link" href="/privacy-policy/" target="_blank">Privacy
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $('#featuredImage').backstretch("https://brownrudnick.com/wp-content/uploads/2016/08/people.jpg");
                })
            </script>
        </div>
    </div>
